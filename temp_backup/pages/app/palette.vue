<template>
  <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
    ...
    <div class="lg:col-span-5 bg-white rounded-lg p-6 shadow-sm">
      ...
      <p class="text-lg mb-6">{{ $t('home.seoDescription') }}</p>
      ...
      <!-- 调色板数量 -->
      <p class="italic text-xs text-center mt-8">
    ...
    <div class="lg:col-span-7 bg-white rounded-lg p-6 shadow-sm">
      ...
      <!-- 空状态 -->
      <div v-else-if="!currentPalette" class="flex flex-col items-center justify-center py-12 border border-dashed border-gray-200 rounded-lg">
        <UIcon name="i-heroicons-paint-brush" class="text-gray-400 h-12 w-12 mb-4" />
        <p class="text-gray-500">{{ $t('app.palette.emptyState') }}</p>
      </div>
