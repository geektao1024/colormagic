<template>
  <div>
    ...
    <div class="mb-8">
      ...
      <p class="text-lg text-gray-300">{{ $t('app.workspace.description') }}</p>
    </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          <div class="flex items-start">
            <div class="bg-primary/20 p-3 rounded-lg mr-3">
              <UIcon 
                :name="tool.icon" 
    ...
    <div
      v-else
      class="mt-8 border border-dashed border-gray-700 rounded-lg p-8 text-center bg-gray-800"
    >
      <UIcon
      ...
      <UButton
        ...
        :label="$t('home.colorGeneratorTitle')"
      />
    </div>
  </div>
</template>
