    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="mb-8">
        ...
        <div class="relative mb-3">
          <h1 class="text-2xl font-bold bg-gradient-to-r from-[#FF5F6D] to-[#FFC371] bg-clip-text text-transparent inline-block">
        ...
        <!-- description-->
        <p class="text-white/70 mb-4 max-w-xl">
          {{ $t('contrastChecker.seoDescription') }}
        </p>
      </div>

      <!-- color -->
      <div class="overflow-hidden border border-white/10 rounded-2xl mb-6 bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-xl shadow-xl relative">
        ...
        <ul class="flex flex-wrap gap-4 sm:gap-8 p-4 border-t border-white/10">
          <li>
          ...
          <li>
            ...
            <UBadge
              ...
              variant="soft"
              :class="contrastRatio >= 4.5 ? 'bg-green-500/20 text-green-300' : 'bg-red-500/20 text-red-300'"
          ...
          <li>
            ...
            <UBadge
              ...
              variant="soft"
              :class="contrastRatio >= 3 ? 'bg-green-500/20 text-green-300' : 'bg-red-500/20 text-red-300'"
      ...
      <UForm
        :state="state"
        :schema="FormSchema"
        class="grid sm:grid-cols-2 gap-6 items-start"
      >
        <!-- primary -->
        <div class="border border-white/10 rounded-2xl overflow-hidden bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-xl shadow-xl relative">
          <div class="absolute -top-10 -left-10 w-40 h-40 bg-[#FF5F6D]/10 rounded-full blur-[60px] -z-10"></div>
          ...
          <div class="p-6 space-y-4">
            ...
            <UButton
              ...
              block
              class="bg-gradient-to-r from-[#FF5F6D] to-[#FFC371] border-0 hover:shadow-lg transition-all duration-300"
          ...
          <div
            v-if="primaryHasChanges"
            class="flex gap-4 items-center border-t border-white/10 bg-white/5 backdrop-blur-sm"
          >
            <div
              class="w-20 h-20"
      ...
      <!-- description + links -->
      <div class="my-8 text-white/70 bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/10 shadow-xl relative">
