...
import __esModule from "#build/tailwind.config/__esModule.mjs"
...
const config = { theme, corePlugins, plugins, content, darkMode, safelist, __esModule, variants, presets, prefix, important, separator, blocklist }
export { config as default, theme, corePlugins, plugins, content, darkMode, safelist, __esModule, variants, presets, prefix, important, separator, blocklist }